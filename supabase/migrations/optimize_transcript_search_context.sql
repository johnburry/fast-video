-- Migration: Optimize transcript_search_context materialized view
-- Replace the slow correlated subquery approach with window functions
...
-- Create optimized materialized view using window functions
