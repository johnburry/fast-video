-- Update semantic search function to support both channel handle and channel ID filtering

-- Drop existing function
drop function if exists search_transcripts_semantic(text, text, uuid, float, int);

-- Create updated function with both channel_handle and channel_id filtering
...
Supports filtering by channel handle, channel ID, or tenant ID.';
