-- Migration: Filter search results to exclude low-quality transcripts (v5 - Fixed DROP)
-- This ensures that videos with only music/applapse/filler content don't appear in search results

-- 1. Drop ALL existing versions of the semantic search function
-- Using a simpler approach that extracts just the signature
DO $$
DECLARE
  func_record RECORD;
BEGIN
