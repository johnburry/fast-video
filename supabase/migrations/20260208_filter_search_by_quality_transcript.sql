-- Migration: Filter search results to exclude low-quality transcripts
-- This ensures that videos with only music/applause/filler content don't appear in search results

-- 1. Update the materialized view to only include quality transcripts
...
-- 2. Update the semantic search function to filter by quality transcripts
