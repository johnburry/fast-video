            ...
            <div className="flex flex-col md:flex-row gap-4">
              ...
              {selectedVideo.matchText && (
                <div className="w-full md:w-80 bg-white rounded-lg p-4 flex-shrink-0">
                  ...
                  <div className="border-l-4 border-blue-500 pl-3 py-2 bg-gray-50 relative">
                    <button
                      className="flex items-center gap-2 mb-2 cursor-pointer hover:opacity-70 transition-opacity bg-transparent border-0 p-0 text-left w-full relative z-10"
                      style={{ pointerEvents: 'auto' }}
                      onClick={(e) => {
                        e.preventDefault();
                        e.stopPropagation();
                        console.log('Play from here clicked!', selectedVideo.startTime);
                      ...
                      type="button"
                    >
                      <span className="text-sm font-medium text-blue-600" style={{ pointerEvents: 'none' }}>
                        {selectedVideo.startTime ? formatTimestamp(selectedVideo.startTime) : '0:00'}
                      </span>
                      <svg className="w-4 h-4 flex-shrink-0" viewBox="0 0 24 24" fill="#FF0000" style={{ pointerEvents: 'none' }}>
                        <path d="M23.498 6.186a3.016 3.016 0 0 0-2.122-2.136C19.505 3.545 12 3.545 12 3.545s-7.505 0-9.377.505A3.017 3.017 0 0 0 .502 6.186C0 8.07 0 12 0 12s0 3.93.502 5.814a3.016 3.016 0 0 0 2.122 2.136c1.871.505 9.376.505 9.376.505s7.505 0 9.377-.505a3.015 3.015 0 0 0 2.122-2.136C24 15.93 24 12 24 12s0-3.93-.502-5.814zM9.545 15.568V8.432L15.818 12l-6.273 3.568z"/>
                      </svg>
                      <span className="text-sm font-medium hover:underline" style={{ color: '#FF0000', pointerEvents: 'none' }}>
                        Play from here
                      </span>
                    </button>
