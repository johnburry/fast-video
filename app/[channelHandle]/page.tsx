      ...
      {searchResults.length === 0 && (
        <div style={{ backgroundColor: '#ffffff', paddingTop: '0.5rem' }}>
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-8">
            ...
            <div className="text-xs md:text-lg flex flex-col md:flex-row md:items-center md:justify-center gap-2 md:gap-1" style={{ color: '#777777' }}>
            ...
            <form onSubmit={handleSearch} className="max-w-3xl mx-auto">
              <div className="flex gap-4">
                <input
                  ...
                  placeholder="Search all channel transcripts"
